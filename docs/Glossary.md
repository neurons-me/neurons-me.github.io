...
Structural Silence
El estado en el que una rama de datos existe y es funcional pero no proporciona metadatos, marcadores ni prefijos en el índice público. Es la realización técnica de la privacidad absoluta en grafos distribuidos.
