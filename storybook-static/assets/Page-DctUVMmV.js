import{aK as c,r as g,j as m}from"./iframe-BMdLsbGP.js";import{u as f}from"./useGuiTheme-DsfZtNW8.js";import{B as v}from"./Box-BwiUMKqP.js";function x({children:i,padding:n=3,background:r="transparent",sx:s={},insetsAware:t=!0}){c();const o=f(),a=g.useMemo(()=>typeof n=="number"?n<=10&&typeof o.spacing=="function"?o.spacing(n):`${n}px`:n??"0px",[n,o]),e=typeof a=="string"&&a.trim().split(/\s+/).length===1?a:void 0,d=t&&e?`calc(${e} + var(--gui-inset-top, 0px))`:void 0,l=t&&e?`calc(${e} + var(--gui-inset-bottom, 0px))`:void 0,u=t&&e?`calc(${e} + var(--gui-inset-left, 0px))`:void 0,p=t&&e?`calc(${e} + var(--gui-inset-right, 0px))`:void 0;return m.jsx(v,{id:"page-container",sx:{flex:1,flexGrow:1,width:"100%",minHeight:"100%",display:"flex",flexDirection:"column",overflowY:"auto",overflowX:"hidden",padding:a,background:r,boxSizing:"border-box",...t&&e&&{padding:0,paddingTop:d,paddingBottom:l,paddingLeft:u,paddingRight:p},...s},children:i})}x.__docgenInfo={description:`Page
----------
